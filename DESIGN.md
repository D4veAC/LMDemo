...
Single lead-prioritization dashboard, optimized for a 1440 × 900 desktop. A scrollable lead queue sits on the left; a more spacious prediction and human-review action sits on the right. White cards on a cool neutral background. No decorative imagery, gradients, or logos.
...
Preserve the selected example probabilities, review status, and responsible-use notice. Do not add feature attribution, admission decisions, personal information, or unsupported performance claims.
